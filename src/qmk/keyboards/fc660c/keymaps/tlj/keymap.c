...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    KC_ESC,   KC_1,   KC_2,   KC_3,   KC_4,   KC_5,   KC_6,   KC_7,   KC_8,   KC_9,   KC_0,   KC_MINS, KC_EQL,  KC_MEBS, KC_INS,
    KC_MEHT,  __________________ALPHA1_L1__________, __________________ALPHA1_R1__________,   KC_LBRC, KC_RBRC, KC_BSLS, KC_DEL,
    KC_ESC,   __________________ALPHA1_L2__________, __________________ALPHA1_R2__________,   KC_QUOT, KC_ENT,
